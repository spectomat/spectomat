...
- `agents/` — `phase-a.md`, `phase-b.md`, `phase-c.md`, `recover.md`. The picker dispatches to one per iteration: `spectomat:phase-a|b|c`, `spectomat:recover`, or `scripts/archive.sh`.
...
- `prompts/` — `implementer.md` and `reviewer.md`, the subagent briefs phase C sends verbatim, placeholders in `<...>`.
